...
$lang = array_merge($lang, array(
	...
	'ACP_PHPBB_SEO_CLASS_EXPLAIN'	=> 'Vous pouvez régler ici différentes options du mod rewrite phpBB SEO.<br/>Les réglages par défaut comme les délimiteurs et les extensions doivent toujours être configurés dans le fichier phpbb_seo_class.php, les modifier implique un changement de .htaccess ainsi que des redirections appropriées.%s',
	'ACP_PHPBB_SEO_VERSION' => 'Version',
	'ACP_SEO_SUPPORT_FORUM' => 'Forum de support',
	// ACP sub cat
	'ACP_FORUM_URL'	=> 'Configuration des URLs des forums',
	'ACP_FORUM_URL_EXPLAIN' => 'Vous pouvez régler ici le contenu du cache, qui sera injecté dans les URLs des forums.<br/>Les forums en vert sont en cache, ceux en rouge ne le sont pas encore.<br/><b style="color:red">Nota Bene :</b><ul style="margin-left:20px;font-size:12px;"><b>mots-cles-fxx/</b> sera toujours convenablement redirigé par le Zéro Duplicate, mais pas si vous le modifiez par la suite : <b>mots-cles/</b> ne sera pas directement redirigé vers <b>autres-mots-cles/</b>.<br/> Dans ce cas, <b>mots-cles/</b> sera considéré comme un forum qui n’existe pas, à défaut de redirections personnalisées.</ul><br/>',
