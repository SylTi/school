<?php 
$this->_tpl_include('overall_header.html'); if ($this->_rootref['U_MCP']) {  ?>
	<div id="pageheader">
...
<!-- STATISTIQUES CONNECTES PHPBB !!-->
	<table class="tablebg" width="100%" cellspacing="1" style="display:none;">
	<tr>
...
<!-- FINSTATISTIQUES CONNECTES PHPBB !!-->
<?php } ?>
<!--STATS PHPBB!-->
<table class="tablebg" width="100%" cellspacing="1" style="text-align:center;margin-top:21px;">
<tr>
