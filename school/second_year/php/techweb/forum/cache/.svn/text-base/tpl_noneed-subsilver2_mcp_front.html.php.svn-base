<?php $this->_tpl_include('mcp_header.html'); if ($this->_rootref['S_SHOW_UNAPPROVED']) {  ?>
	...
	<?php } ?>
	<tr>
		<td class="cat" colspan="6" align="center"><input class="btnmain" type="submit" name="action[approve]" value="<?php echo ((isset($this->_rootref['L_APPROVE'])) ? $this->_rootref['L_APPROVE'] : ((isset($user->lang['APPROVE'])) ? $user->lang['APPROVE'] : '{ APPROVE }')); ?>" />&nbsp;&nbsp;<input class="btnlite" type="submit" name="action[disapprove]" value="<?php echo ((isset($this->_rootref['L_DISAPPROVE'])) ? $this->_rootref['L_DISAPPROVE'] : ((isset($user->lang['DISAPPROVE'])) ? $user->lang['DISAPPROVE'] : '{ DISAPPROVE }')); ?>" /></td>
	</tr>
	</table>
